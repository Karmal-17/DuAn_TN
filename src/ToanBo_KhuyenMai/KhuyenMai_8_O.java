...
public class KhuyenMai_8_O {
    ...
    public KhuyenMai_8_O() {
    }

    public KhuyenMai_8_O(String Ma_KM, String Ten_KM, String MoTa_KM, String HinhThuc_KM, float GiaTri_YeuCau_KM, float GiaTri_KM, Date Ngay_BD, Date Ngay_KT) {
        this.Ma_KM = Ma_KM;
        this.Ten_KM = Ten_KM;
